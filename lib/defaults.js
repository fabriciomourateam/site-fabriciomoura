...
export const DEFAULT_CONTENT = {
  ...
  contato: {
    ...
    msgPadrao: "Oi Fabricio!! Vim através do seu site! Gostaria de saber como funciona seu acompanhamento. {cod}",
    msgAgendar: "Oi Fabricio!! Vim através do seu site! Quero agendar um horário. {cod}",

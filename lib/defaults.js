...
export const DEFAULT_CONTENT = {
  ...
  contato: {
    ...
    // msgAgendar propositalmente igual à msgPadrao (o dono quer a mesma mensagem em todos os botões, como no WordPress).
    msgPadrao: "{cod} Oi Fabricio!! Vim através do seu site! Gostaria de saber como funciona seu acompanhamento.",
    msgAgendar: "{cod} Oi Fabricio!! Vim através do seu site! Gostaria de saber como funciona seu acompanhamento.",
